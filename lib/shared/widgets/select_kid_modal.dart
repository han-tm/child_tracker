...
Future<UserModel?> showKidSelectorModalBottomSheet(BuildContext context) async {
...
class _SelectKidContentState extends State<_SelectKidContent> {
  ...
  initState() {
    super.initState();
    selectedKid = context.read<TaskCubit>().state.selectedKid;
  }
                ...
                children: [
                  ...
                  Expanded(
                    child: FilledAppButton(
                      text: 'select'.tr(),
                      onTap: () {
                        context.read<TaskCubit>().onKidSelected(selectedKid);
