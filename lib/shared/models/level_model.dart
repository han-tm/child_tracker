...
// class LevelUserModel {
//   final String id;
//   final int levelPoints;
//   final List<LevelGameDataModel> levelGames;

//   LevelUserModel({
//     required this.id,
//     this.levelPoints = 0,
//     this.levelGames = const [],
//   });

//   factory LevelUserModel.fromFirestore(DocumentSnapshot snapshot) {
//     final json = snapshot.data()! as Map<String, dynamic>;
//     return LevelUserModel(
//       id: snapshot.id,
//       levelPoints: json['level_points'] as int? ?? 0,
//       levelGames:
//           (json['level_games'] as List<dynamic>?)?.map((e) => LevelGameDataModel.fromFirestore(e)).toList() ?? [],
//     );
//   }
...
//   factory LevelGameDataModel.fromFirestore(Map<String, dynamic> data) {
//     return LevelGameDataModel(
//       gameRef: data['game'] as DocumentReference?,
