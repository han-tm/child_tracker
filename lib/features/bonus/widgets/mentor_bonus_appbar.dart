...
class MentorBonusAppbarWidget extends StatelessWidget {
  final UserModel? selectedKid;

  const MentorBonusAppbarWidget({super.key, this.selectedKid});
    ...
    return Container(
      ...
      child: Row(
        children: [
          GestureDetector(
            onTap: () {
              showBonusKidSelectorModalBottomSheet(context);
            },
